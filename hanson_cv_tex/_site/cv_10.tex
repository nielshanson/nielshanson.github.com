...
\header{Niels}{Hanson}{Bioinformatics Ph.D. Candidate } % Your name and current job title/field
...
\item
  ...
  Manuel Martinez-Garcia, Jos\'{e} M. González, Haiwei Luo, Jody J. Wright,
...
\begin{itemize}
	\item World Map: World map displaying metagenomic sequencing data from IMG/M. \href{http://goo.gl/WVjdAv}{http://goo.gl/WVjdAv}
	...
	\item Heatmap: Heatmap with calculated marginal distributions. \href{http://goo.gl/3dIurm}{http://goo.gl/3dIurm}
\end{itemize}
